...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players with zero turns were incorrectly removed instead of being treated as having infinite turns.
    ...
    // Defect(s) Found: Players with negative turns were incorrectly removed instead of being treated as having infinite turns.
